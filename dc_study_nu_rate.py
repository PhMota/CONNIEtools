...
with Timer('presentation'):
    with openBeamer( folder, 'Dark Current study with $nu$ rate \\\\https://github.com/PhMota/CONNIEtools/wiki' ) as doc:
    
        doc.frame('simulate neutrino rate populations',
            'blank image with noise 12 ADU and DC 1e$^-$',
            *makefigure('./simulation image dc_study_nu_rate_test --N 1000 --charge-pdf-table rate_neutrino.dat --dark-current 0 --readout-noise 0 --ccd-shape 4120 4130 --horizontal-overscan 450 --vertical-overscan 70 --charge-gain 7.25 --pdf', 'image dc_study_nu_rate_test.pdf', doc, height=.6 )
        )
